  ...
  for (var i=0; i<scenarioCount; ++i) {
    ...
    describe(scenarioList[i] + ': detailed tx error handling test(s)', function() {
      ...
      describe(scenarioList[i] + ': other tx error handling test(s)', function() {
        ...
        it(suiteName + "transaction.executeSql on BOGUS empty SQL string ('') [TBD SQLCipher for Android & Windows do not report error]", function (done) {
          ...
          db.transaction(function(transaction) {
            ...
            if (isWP8)
              ...
              expect('UNEXPECTED ERROR with message: ' + error.message).toBe('--'); // NOT EXPECTED for Windows
            ...
            // NOT EXPECTED by Web SQL, Android Web SQL, or iOS:
        ...
        it(suiteName + "readTransaction.executeSql on BOGUS empty SQL string ('') [TBD SQLCipher for Android & Windows do not report error]", function (done) {
        ...
        it(suiteName + 'transaction.executeSql on BOGUS number 101 [TBD SQLCipher for Android reports nonsense error message]', function (done) {
        ...
        it(suiteName + 'transaction.executeSql on BOGUS number 0 [TBD SQLCipher for Android reports nonsense error message]', function (done) {
          var db = openDatabase("tx-with-number-101-for-sql-statement.db", "1.0", "Demo", DEFAULT_SIZE);
        ...
        it(suiteName + 'transaction.executeSql with true for SQL statement (BOGUS) [TBD SQLCipher for Android reports nonsense error message]', function (done) {
        ...
        it(suiteName + 'transaction.executeSql with false for SQL statement (BOGUS) [TBD SQLCipher for Android reports nonsense error message]', function (done) {
        ...
        it(suiteName + 'transaction.executeSql with NaN for SQL statement (BOGUS) [TBD SQLCipher for Android reports nonsense error message]', function (done) {
        ...
        it(suiteName + 'readTransaction.executeSql with NaN for SQL statement (BOGUS) [TBD SQLCipher for Android reports nonsense error message]', function (done) {
